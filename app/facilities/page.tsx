...
const amenities = [
  ...
  { icon: "03", title: "Modern Gymnasium", desc: "State-of-the-art fitness center for physical well-being.", gradient: "from-orange-600/20" },
  { icon: "04", title: "Sports Complex", desc: "Dedicated badminton and volleyball courts inside the premises.", gradient: "from-red-600/20" },
  { icon: "05", title: "Common Room", desc: "Entertainment zone with large TV, indoor games, and lounge seating.", gradient: "from-purple-600/20" },
  { icon: "06", title: "Pure Water", desc: "Industrial-grade RO water purifiers and coolers on every wing.", gradient: "from-cyan-600/20" },
];
  ...
  return (
    <PageTransition>
      <div ref={containerRef} className="pb-32 overflow-hidden">
        ...
        {/* ===== BENTO AMENITIES ===== */}
        <section className="max-w-7xl mx-auto px-4 mt-8 z-20 relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {amenities.map((item, i) => (
              <motion.div
                ...
                className={`glass-card p-10 relative overflow-hidden group ${i === 0 || i === 3 ? "md:col-span-2 lg:col-span-2" : ""}`}
              >
                ...
                <div className="relative z-10">
                  <div className="text-6xl font-black font-serif text-white/20 mb-6 bg-dark-900/50 w-24 h-24 flex items-center justify-center rounded-2xl border border-white/5 shadow-2xl">
                    {item.icon}
                  </div>
        ...
        <section className="max-w-6xl mx-auto px-4 mt-32">
          ...
          >
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-orange-600/10 rounded-full blur-[100px] -z-10" />
            
            <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center border-r border-white/5">
              <div className="inline-block px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-400 text-xs tracking-widest uppercase mb-6 self-start font-bold">
