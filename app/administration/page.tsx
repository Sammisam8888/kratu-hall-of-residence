                  ...
                  <div className="space-y-4 mt-auto text-2xl">
                    {profile.email && (
                      <div className="flex items-center gap-4 text-white/50 text-sm bg-white/5 px-4 py-3  border border-white/5">
                        ...
                        <a href={`mailto:${profile.email}`} className="font-mono text-xl font-semibold break-all hover:text-yellow-100 transition-colors uppercase cursor-pointer">{profile.email}</a>
                      </div>
                    )}
                    {profile.phone && (
                      <div className="flex items-center gap-4 text-white/50 text-xl font-semibold bg-white/5 px-4 py-3  border border-white/5">
                        ...
                        <a href={`tel:${profile.phone}`} className="font-mono text-xl font-semibold break-all hover:text-yellow-100 transition-colors cursor-pointer">{profile.phone}</a>
                      </div>
                    )}
                  </div>
                </div>
