  ...
  return (
    <PageTransition>
      ...
      <div ref={containerRef} className="relative w-full">
        {/* ===== MASSIVE HERO ===== */}
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden container-page">
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center text-center max-w-4xl z-10"
          >
            <motion.div
              ...
              className="mb-8"
            >
              <div className="inline-flex items-center gap-3 px-6 py-2  border border-yellow-100/30 bg-yellow-100/5 backdrop-blur-md">
                <span className="w-2 h-2  bg-yellow-100 animate-pulse" />
            ...
            >
              <Link
                href="/about"
                className="inline-flex items-center justify-center bg-yellow-100 text-dark-950 font-bold px-10 py-4  text-lg hover:scale-105 hover:bg-white transition-all duration-300 shadow-[0_0_30px_rgba(252,246,186,0.3)]"
              >
                Enter The Legacy
              </Link>
              <Link
                href="/administration"
                className="inline-flex items-center justify-center border border-yellow-100/50 bg-dark-900/50 backdrop-blur-md text-yellow-100 font-bold px-10 py-4  text-lg hover:border-yellow-100 hover:bg-yellow-100/10 transition-all duration-300"
              >
                Meet The Team
              </Link>
            </motion.div>
        ...
        <section className="relative section-spacing container-page z-20 flex justify-center">
          <motion.div
            ...
            className="w-full max-w-7xl flex flex-wrap justify-center gap-6 md:gap-12"
          >
            {[
              ...
              <motion.div
                ...
                className="relative bg-dark-900/40 backdrop-blur-2xl border border-yellow-100/10  p-8 min-w-[200px] md:min-w-[250px] flex flex-col items-center justify-center shadow-2xl overflow-hidden group"
              >
          ...
          <div className="w-full max-w-7xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 auto-rows-[350px] lg:auto-rows-[400px]">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
                className="lg:col-span-2 relative  overflow-hidden group bg-dark-800 border border-white/5"
              >
                <Image
                  src="/hostel-images/kratu-hall-front-gate.png"
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col justify-end">
                  <div className="w-12 h-12  border border-yellow-100/30 flex items-center justify-center text-yellow-100 mb-6 backdrop-blur-md">
                    ✦
                  </div>
              ...
              <motion.div
                ...
                className="relative  overflow-hidden group bg-gradient-to-b from-dark-800 to-dark-900 border border-white/5 p-8 flex flex-col"
              >
                <div className="absolute -right-20 -top-20 w-64 h-64 bg-emerald-600/10  blur-3xl opacity-50 transition-opacity duration-1000 group-hover:opacity-100" />
              ...
              <motion.div
                ...
                className="relative  overflow-hidden group bg-dark-900 border border-white/5 p-8"
              >
                <div className="absolute left-0 bottom-0 w-64 h-64 bg-red-600/10  blur-3xl opacity-50 transition-opacity duration-1000 group-hover:opacity-100" />
              ...
              <motion.div
                ...
                className="relative  overflow-hidden group bg-dark-900 border border-white/5 p-8"
              >
                <div className="absolute left-0 bottom-0 w-64 h-64 bg-orange-600/10  blur-3xl opacity-50 transition-opacity duration-1000 group-hover:opacity-100" />
              ...
              <motion.div
                ...
                className="relative  overflow-hidden group bg-dark-800 border border-white/5"
              >
                <Image
                  src="/hostel-images/kratu-hall-daylight-view.HEIC"
                  alt="Kratu Hall Day"
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  <span className="px-4 py-2  bg-dark-900/80 backdrop-blur-md text-white/80 text-sm font-medium border border-white/10">
                    Daylight View
                  </span>
                </div>
              </motion.div>
        ...
        <section className="relative section-spacing container-page overflow-hidden flex justify-center">
          <div className="absolute inset-0 top-1/2 -translate-y-1/2 w-full h-[500px] bg-yellow-100/5 blur-[100px] -z-10" />
          
          <div className="w-full max-w-6xl relative [3rem] p-10 md:p-20 overflow-hidden bg-gradient-to-br from-dark-800/80 to-dark-950/80 backdrop-blur-2xl border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.5)]">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-yellow-100/10 to-transparent  blur-3xl -z-10 translate-x-1/3 -translate-y-1/3" />
            ...
            >
              <div className="w-48 h-48 md:w-80 md:h-80 shrink-0 relative  overflow-hidden shadow-[0_0_50px_rgba(245,197,24,0.2)] group">
                <Image
              ...
              <div className="flex-1 text-center lg:text-left relative">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/10 pt-8">
                  ...
                  <Link href="/administration" className="px-6 py-3  border border-white/20 hover:border-yellow-100 hover:text-yellow-100 text-white/60 transition-all text-sm font-medium">
                    View Administration →
                  </Link>
                </div>
              </div>
        ...
        {/* ===== FOOTER CTA ===== */}
        <section className="relative section-spacing container-page text-center">
          <motion.div
          ...
          >
            ...
            <Link
              href="/facilities"
              className="inline-flex items-center justify-center bg-yellow-100 text-dark-950 font-bold px-12 py-5  text-xl shadow-[0_0_40px_rgba(252,246,186,0.3)] hover:scale-105 hover:bg-white transition-all duration-300"
            >
              Discover Facilities
            </Link>
          </motion.div>
