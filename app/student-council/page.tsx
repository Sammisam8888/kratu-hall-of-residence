...
const secretaries = [
  ...
  { role: "Health & Hygiene Secretary", name: "Balaji Kumar Sahu", branch: "ETC, 3rd Yr", phone: "7077431215", img: "/student-council-images/balaji-kumar-sahu-health-secretary.png", bg: "from-emerald-600/20", ph: true },
        ...
        <section className="relative min-h-[60vh] flex flex-col items-center justify-center pt-32 px-4 text-center">
          <motion.div style={{ y }} className="z-10 w-full max-w-5xl">
            ...
            <motion.div
              ...
              className="inline-block px-8 py-3 rounded-full border border-yellow-100/30 bg-yellow-100/10 text-yellow-100 font-bold tracking-widest uppercase text-xl"
            >
              Session 2025-26
            </motion.div>
          </motion.div>
            ...
            {secretaries.map((sec, i) => (
              ...
              >
                ...
                <div className={`relative z-10 ${i === 0 ? "md:w-1/2 md:pl-12" : "text-center"}`}>
                  <h4 className="text-yellow-100 font-bold uppercase tracking-widest text-xs mb-2">{sec.role}</h4>
                  ...
                  <p className="inline-block px-4 py-2 rounded-full border border-white/10 bg-white/5 text-white/70 text-sm"><span className="text-yellow-100 font-bold text-[10px] uppercase tracking-widest mr-2">Tel</span>{sec.phone}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            {councilors.map((c, i) => (
              ...
              >
                <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-yellow-100/30 mb-6 relative">
                  {c.ph ? (
                ...
                <p className="text-white/60 text-sm bg-dark-900 px-4 py-1 rounded-full border border-white/5"><span className="text-yellow-100 font-bold text-[9px] uppercase tracking-widest mr-2">Tel</span>{c.phone}</p>
              </motion.div>
            ))}
          </div>
        </section>
