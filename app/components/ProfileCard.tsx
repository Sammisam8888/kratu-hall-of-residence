      ...
      <div className="p-5">
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          {phone && (
            <a
              href={`tel:${phone}`}
              className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full bg-yellow-100/10 text-yellow-100/80 hover:bg-yellow-100/20 transition-colors"
            >
